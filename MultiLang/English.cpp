...
static constexpr const char* debugger_profiler = "Profiler";
static constexpr const char* profiler_function = "Function";
static constexpr const char* profiler_pct_cpu = "% CPU";
static constexpr const char* profiler_pct_mem = "% Mem";
static constexpr const char* profiler_calls = "Calls";
static constexpr const char* profiler_total_ms = "Total ms";
static constexpr const char* profiler_self_ms = "Self ms";
static constexpr const char* profiler_avg_ms = "Avg ms";
static constexpr const char* profiler_max_ms = "Max ms";
static constexpr const char* profiler_net_objs = "Net Objs";
static constexpr const char* profiler_net_strs = "Net Strs";
static constexpr const char* profiler_max_obj_delta = "Max Obj Chg";
